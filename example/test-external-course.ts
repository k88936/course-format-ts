import {Course, CourseMode, Lesson, loadFromYamlZip, Section, Task} from "../src";
...
async function main() {
  ...
  console.log(`  courseMode: ${course.courseMode}`)
  ...
  console.log(`  courseMode: ${course.courseMode} (${course.courseMode === CourseMode.STUDENT ? 'STUDENT' : 'EDUCATOR'})`)
